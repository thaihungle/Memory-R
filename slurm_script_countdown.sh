...
# Run you sh script
#CUDA_VISIBLE_DEVICES=0 python run_countdown.py --config config_countdown.yaml --model_name_or_path Qwen/Qwen2.5-0.5B-Instruct --use_ir knn+ --k 3 --seed 0 --num_train 10000
CUDA_VISIBLE_DEVICES=0 python run_countdown.py --config config_countdown.yaml --model_name_or_path $1 --use_ir $2 --k $3 --seed $4 --num_train $5
